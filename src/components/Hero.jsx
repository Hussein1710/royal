  ...
  return (
    <div>
        ...
        <div className="flex flex-col m-2 md:text-5xl text-left items-start justify-center gap-4 font-bold font-sans w-full md:w-1/2">
          <p className='text-white text-left text-4xl font-bold'>Welcome To Dubai Royal Council Cabinet <span className='text-green-600 text-center'>We Appreciate you here</span></p>
